...
console.log(`extracted ${extraction.rates.length} standard rates, ${extraction.peak_rates.length} peak rates`);
...
const { costById: peakCostById, problems: peakProblems } = resolveRates(extraction.peak_rates, models, false);
