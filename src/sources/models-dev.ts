// Build-time seed for the metadata fields no Ollama endpoint exposes:
// description and temperature. models.dev is the ecosystem's canonical dataset
// (the old repo's updater seeded from it too); it is read here, at update time
// only. The published artifact stays dependency-free. Absence is the honest
// answer when neither the seed nor the previous artifact has the data: the
