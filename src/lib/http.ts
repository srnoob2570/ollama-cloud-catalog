...
export async function fetchJson<T>(url: string, init?: RequestInit, impl: FetchImpl = fetch): Promise<T> {
...
export async function fetchText(url: string, init?: RequestInit, impl: FetchImpl = fetch): Promise<string> {
